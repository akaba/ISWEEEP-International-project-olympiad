...
public partial class Admin_VisaLetter : System.Web.UI.Page
{
    ...
    private void PutTravelInfo()
    {
        ...
        for (int i = 0; i < dtASV.Rows.Count; i++)
        {
            ...
            sb.Append("<hr><br><b style='color:blue'>Adult SV:</b>" + dtASV.Rows[i]["asv"].ToString() + "  [ <a target=_blank href=travelinfo.aspx?asvid=" + asvid + ">Travel Details</a> ]");

            sb.Append("[ <a target=_blank href=Letter.aspx?asvid=" + asvid + ">Visa Letter</a> ]<br>");
            ...
            {
                sb.Append("&nbsp;&nbsp;" + (j + 1) + ".&nbsp;<a target=_blank href=contestantdetails.aspx?cid=" + dtContestants.Rows[j]["contestantid"].ToString() + ">" +
    ...
    private void Filter()
    {
        ...
        StringBuilder sb = new StringBuilder("");
        sb.Append("<hr><br><b style='color:blue'>Adult SV:</b>" + dtASV.Rows[0]["asv"].ToString() + "  [ <a target=_blank  href=travelinfo.aspx?asvid=" + asvid + ">Travel Details</a> ]");
        sb.Append("[ <a target=_blank href=Letter.aspx?asvid=" + asvid + ">Visa Letter</a> ]<br>");
