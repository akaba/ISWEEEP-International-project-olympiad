<%@ Page Title="" Language="C#" MasterPageFile="~/AdultSV/adultSV.master" AutoEventWireup="true" CodeFile="Local_US_Embassy.aspx.cs" Inherits="AdultSV_Local_US_Embassy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cp1" runat="server">
        ...
        <b>Physical Address of Local U.S. Embassy - Visa Department </b><br />
        <asp:Label ID="lblMessage" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
        <br />
       
    Use the link below to obtain information on U.S. embassy or consulate locations and addresses around the world<br />
        <a href="http://www.usembassy.gov/" target="_blank" title="Find my U.S. embassy or consulate">Find my local U.S. embassy or consulate.</a>
    <br /><br />
     Please provide the physical address of Local U.S. Embassy - Visa Department.<br />    
      <b>*A copy of Visa Letter will be sent to this address</b>
    <br /><br />
        <table>
            <tr>
                <td>
                    Name of Embassy :</td>
                <td>
                    <asp:TextBox ID="txtEmbassy" runat="server" Width="450px"></asp:TextBox>
                        </td>
                <td>
                     
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server"  ControlToValidate="txtEmbassy" Display="Dynamic" ErrorMessage="Required"></asp:RequiredFieldValidator></td>
            </tr>   
        ...
        <asp:DropDownList ID="ddCountry" runat="server" >
            ...
            <asp:ListItem Value="PW">Palestinian Territory</asp:ListItem>
    ...
    <br />
        ...
        SelectCommand="select * from Embassy WHERE ([ASVID] = ?)">
            <SelectParameters>
