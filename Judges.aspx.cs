...
public partial class Judges : Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (!saved)
        {
            ...
            string mesaj = "Thank you for registering as a judge for I-SWEEEP.<br>";
            mesaj += "You will be contacted by the organization committee.<br><br>";
            ...
            es.sendMail(mesaj2, "I-Sweeep Judge Registration", "info@isweeep.org", "judging@isweeep.org");
